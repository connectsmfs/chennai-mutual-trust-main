import { Shield, Users, FileCheck, MapPin, CompassIcon } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Over 20+ years of building trust with families around South India through transparent and ethical practices.",
    ...
    },
    {
      ...
      description: "From planning to monitoring, we guide you through every stage of your investment journey.",
      color: "from-accent to-primary",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Experience the difference of working with South India's most trusted mutual fund distributor
          </p>
        </div>
